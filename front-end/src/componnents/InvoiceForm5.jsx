...
const ContactSection = ({ index, onRemoveItem }) => {
          ...
          <div className=" w-full">
            <table className="table px-4 min-w-full rounded-md border border-gray-200 overflow-hidden ">
              <thead className="bg-gray-100  ">
                <tr>
                  <th className="text-left text-xs font-medium uppercase tracking-wide" scope="col">
                    <label htmlFor="item" className="block text-gray-700 font-bold mb-2">items</label>
                  </th>
                  <th className="py-3 px-4 text-left text-xs font-medium uppercase tracking-wide" scope="col">
                    <label htmlFor="quantity" className="block text-gray-700 font-bold mb-2">Qty</label>
                  </th>
                  <th className="py-3 px-4 text-left text-xs font-medium uppercase tracking-wide" scope="col">
                    <label htmlFor="price" className="block text-gray-700 font-bold mb-2">Price</label>
                  </th>
                  <th className="py-3 px-4 text-left text-xs font-medium uppercase tracking-wide" scope="col">
                    <label htmlFor="total" className="block text-gray-700 font-bold mb-2">Total</label>
                  </th>
                  <th className="py-3 px-4 text-left text-xs font-medium uppercase tracking-wide" scope="col">
                    <label htmlFor="actions" className="block text-gray-700 font-bold mb-2">Actions</label>
                  </th>
                </tr>
              </thead>
              <tbody>
